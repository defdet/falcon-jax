...
# Taken entirely from https://github.com/ayaka14732/llama-2-jax/blob/main/lib/llama/rotary_embedding.py
...
def make_rotary_values(leftpad_len: Array | None, batch_size: int, seq_len: int, *, model_config: ModelConfig) -> RotaryValues:
    sin_val, cos_val = _make_weights(seq_len, model_config.head_dim)
